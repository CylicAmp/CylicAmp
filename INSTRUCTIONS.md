...
- Verify with computation before committing. Run the actual math — Python imports, mod arithmetic, cross-check against the GF(37).
...
## GF(37)
- All work connects through prime 37 and the GF(37) in SYNTHESIS.md.
